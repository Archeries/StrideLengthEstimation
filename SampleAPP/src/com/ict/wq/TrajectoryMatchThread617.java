 ...
 */
public class TrajectoryMatchThread617  {

	private Context mContext;
	private Handler mhandler;

	public TrajectoryMatchThread617(Context mContext, Handler mhandler) {
		super();
...
//	private static double miniTotalLength = 10000;
	...
	public static void setResultArrayList(ArrayList<Sample> resultArrayList) {
		TrajectoryMatchThread617.resultArrayList = resultArrayList;
	}
	...
	public static void setOffSet(double offSet) {
		TrajectoryMatchThread617.offSet = offSet;
	}
...
//	}
	...
	public ArrayList<Sample> coarsnessDTW(ArrayList<Sample> fineSubSampleList,
		...
		if (coarseMatchedSampleList.size() == 0) {
			if (isIncrement) {
				...
				// SensorDataLogFileDB.trace("\n\n");
				// for (int i = 0; i < coarseSubSampleListReverse.size(); i++) {
				// coarseSampleListReverse.add(coarseSubSampleListReverse
				// .get(i));
				// }
	...
	public ArrayList<ArrayList<Sample>> getCoarsnessDTWData(
		...
		for (int i = 0; i < subSampleListOrigin.size(); i++) {
